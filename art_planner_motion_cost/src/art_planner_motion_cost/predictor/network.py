...
class network(nn.Module):
    ...
    def __init__(self):
        ...
        # Init stage
        self.init_conv1 = nn.Conv2d(1, 32, (3, 3), stride=1, dilation=1, bias=False)
        self.init_conv1_bn = nn.BatchNorm2d(32)

        self.init_conv2 = nn.Conv2d(32, 32, (3, 3), stride=1, dilation=1, bias=False)
        self.init_conv2_bn = nn.BatchNorm2d(32)

        self.init_conv3 = nn.Conv2d(32, 64, (3, 3), stride=1, dilation=1, bias=False)
        self.init_conv3_bn = nn.BatchNorm2d(64)

        self.init_conv4 = nn.Conv2d(64, 64, (3, 3), stride=1, dilation=1, bias=False)
        self.init_conv4_bn = nn.BatchNorm2d(64) 

        self.init_conv5 = nn.Conv2d(64, 64, (3, 3), stride=1, dilation=1, bias=False)
        self.init_conv5_bn = nn.BatchNorm2d(64)     

        # Flatten
        self.init_flatten = nn.Conv2d(64, 64, (15, 15), stride=1, dilation=1, bias=False)
        self.init_flatten_bn = nn.BatchNorm2d(64)
        ...
        # Output stage
        self.out0_conv1 = nn.Conv2d(80, 64, (1, 1), stride=1, dilation=1, bias=False)
        self.out0_conv1_bn = nn.BatchNorm2d(64)

        self.out1_conv1 = nn.Conv2d(64, 32, (1, 1), stride=1, dilation=1, bias=False)
        self.out1_conv1_bn = nn.BatchNorm2d(32)

        self.out1_conv2 = nn.Conv2d(64, 32, (1, 1), stride=1, dilation=1, bias=False)
        self.out1_conv2_bn = nn.BatchNorm2d(32)

        self.out1_conv3 = nn.Conv2d(64, 32, (1, 1), stride=1, dilation=1, bias=False)
        self.out1_conv3_bn = nn.BatchNorm2d(32)

        self.out2_conv1 = nn.Conv2d(32, 1, (1, 1), stride=1, dilation=1, bias=True)

        self.out2_conv2 = nn.Conv2d(32, 1, (1, 1), stride=1, dilation=1, bias=True)

        self.out2_conv3 = nn.Conv2d(32, 1, (1, 1), stride=1, dilation=1, bias=True)
    ...
    def FCpart(self, features, target):
        ...
        risk = torch.ones(prob.size(), dtype=torch.float32, device='cuda')
